'''
$Id: amplifier_dummy.py
$auth: Steve Torchinsky <satorchi@apc.in2p3.fr>
$created: Tue 05 Mar 2024 16:21:38 CET
...
This is a dummy class based on the amplifier_femto which only works on a Raspberry Pi which has the gpio
Call this class from x86 computer
This is necessary because the qubic_bot calls the calsource_configuration_manager, which calls the amplifier
'''
...
class amplifier:
    '''
    a dummy class to pretend to be the amplifier
    '''
    verbosity = 2
